...
plt.xlabel('Rho')
plt.ylabel('Error')
plt.title('Community Test Error 10 Trials (Protecting Education)')
plt.legend()
plt.show()
...
plt.title('Community Test Statistical Parity 10 Trials (Education)')
plt.legend()
plt.show()
...
plt.title('Community Test Normed Disparate 10 Trials (Education)')
plt.legend()
plt.show()
